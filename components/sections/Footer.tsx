...
export default function Footer() {
  return (
    ...
    <footer className="relative flex aspect-[10/3] max-h-[432px] min-h-[200px] items-end overflow-hidden bg-[linear-gradient(to_bottom,#f4f6fa,#6e8fc1)] px-4 pb-8 shadow-[0_2px_0_0_#6e8fc1] sm:px-6 md:px-10 md:pb-12">
